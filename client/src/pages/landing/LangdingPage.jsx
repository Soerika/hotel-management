...
function LangdingPage() {
  return (
    <div>
      ...
      <div className="mt-16 bg-gray-100 pt-8 pb-16">
        <h2 className="text-5xl text-center font-bold">Our service</h2>
        <div className="grid grid-cols-3 gap-x-8 gap-y-4 mt-12 px-12 text-2xl">
          <label className="border border-gray-500 p-4 flex rounded-2xl gap-2 items-center  ">
            <svg
      ...
      <div id="contact" style={{ "scroll-margin-top": "140px" }}>
        ...
        <div className="grid grid-cols-2 gap-32 w-2/3 m-auto ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 790 563"
            fill="none"
